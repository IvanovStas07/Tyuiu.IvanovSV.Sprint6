...
using Tyuiu.IvanovSV.Sprint6.Task1.V28.Lib;

namespace Tyuiu.IvanovSV.Sprint6.Task1.V28
{
    public partial class FormMain : Form
    {
        ...
        private void buttonDone_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                textBoxResult.AppendText("|    õ     |   f(x)   |" + Environment.NewLine);
                textBoxResult.AppendText("----------+---------" + Environment.NewLine);
            ...
            {
                MessageBox.Show("Не то вводишь ","СТОООООЙ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void buttonHelp_Click(object sender, EventArgs e)
        {
            MessageBox.Show("ИВАНОВ С. В. ИСТНб-25-1 .", "Молодцом", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
